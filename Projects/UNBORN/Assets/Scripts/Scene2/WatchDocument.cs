...
public class WatchDocument : MonoBehaviour {
    ...
    void Update() {
        ...
        else if (Physics.Raycast(player.transform.position, player.transform.TransformDirection(Vector3.forward), out hit, 1.5f)) {
